...
// BuildSpec constructs an OpenAPI specification from the parsed API definitions.
func BuildSpec(apiDefs []APIDefinition) (*openapi3.T, error) {
	spec := &openapi3.T{
		OpenAPI: "3.0.0",
		Info: &openapi3.Info{
			Title:       "Maltose Generated API",
			Version:     "1.0.0",
			Description: "API documentation generated by maltose cli.",
		},
