...
func (c *TestRouterController) Hello(ctx context.Context, req *HelloReq) (*HelloRes, error) {
...
func (c *TestRouterController) UpdateUser(ctx context.Context, req *UserReq) (*UserRes, error) {
...
func TestRouter_ControllerBinding_SimpleGET(t *testing.T) {
	teardown := setupServer(t, func(s *mhttp.Server) {
...
func TestRouter_ControllerBinding_PathAndBody(t *testing.T) {
	teardown := setupServer(t, func(s *mhttp.Server) {
		s.Bind(&TestRouterController{})
	})
	defer teardown()
